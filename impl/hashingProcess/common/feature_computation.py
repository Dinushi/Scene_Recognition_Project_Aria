...
def computeFPFHFeatures(pcd, normal_radius_max=0.1, normal_max_nn = 30, FPFH_radius_max=0.5, FPFH_max_nn=100):
    ...
    pcd.estimate_normals(o3d.geometry.KDTreeSearchParamHybrid(radius=float(normal_radius_max), max_nn=int(normal_max_nn)))
    pcd_fpfh = o3d.pipelines.registration.compute_fpfh_feature(pcd, o3d.geometry.KDTreeSearchParamHybrid(radius=float(FPFH_radius_max), max_nn=int(FPFH_max_nn)))
